...
class ArticuloAutorController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('ArticuloAutor');
	 ...
	 * @return ArticuloAutor the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=ArticuloAutor::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param ArticuloAutor $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='articulo-autor-form')
		{
